...
namespace Teaq
{
    ...
    {
        /// <summary>
        /// Queries the repository for a single value.
        /// </summary>
        /// <typeparam name="T">The value type to be returned.</typeparam>
        /// <param name="command">The command to execute.</param>
        /// <param name="handler">An optional handler function to read the record.</param>
        /// <returns>
        /// The value or the null if the result is null.
        /// </returns>
        T? QueryValue<T>(QueryCommand command, Func<IDataRecord, T?> handler = null) where T : struct;
