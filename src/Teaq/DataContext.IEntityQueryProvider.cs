...
namespace Teaq
{
    ...
    public sealed partial class DataContext : IEntityQueryProvider
    {
        ...
        {
            return this.Query(query, parameterProps.GetAnonymousParameters(), new DelegatingReaderHandler<TEntity>(handler), null);
        }
        ...
        {
            return this.Query(query, parameterProps.GetAnonymousParameters(), handler, null);
        }
        ...
        {
            return this.Query(command.CommandText, command.GetParameters(), handler, null);
        }
        ...
        /// An enumerable collection of results of the specified type.
        /// </returns>
        public async Task<IEnumerable<TEntity>> QueryAsync<TEntity>(string query, Func<IDataReader, TEntity> handler, object parameterProps = null) where TEntity : class
        {
            return await this.QueryAsync(query, parameterProps.GetAnonymousParameters(), new DelegatingReaderHandler<TEntity>(handler), null);
        }
        ...
        /// </returns>
        public async Task<IEnumerable<TEntity>> QueryAsync<TEntity>(QueryCommand<TEntity> command, Func<IDataReader, TEntity> handler) where TEntity : class
        {
        ...
        /// An awaitable, enumerable collection of results of the specified type.
        /// </returns>
        public async Task<IEnumerable<TEntity>> QueryAsAsync<TEntity>(QueryCommand command, IDataHandler<TEntity> handler) where TEntity : class
        {
            return await this.QueryAsync(command.CommandText, command.GetParameters(), handler, null);
        }
