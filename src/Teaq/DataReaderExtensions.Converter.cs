    ...
    public static partial class DataReaderExtensions
    {
        private static readonly Dictionary<TypePair, Func<object, object>> Converters =
            new Dictionary<TypePair, Func<object, object>>(256, new TypePairComparer())
            {
                ...
                [new TypePair(T<byte>(), T<bool>())] = o => ((byte)o) != 0,
                [new TypePair(T<byte>(), T<bool?>())] = o => new bool?(((byte)o) != 0),
                [new TypePair(T<byte>(), T<byte?>())] = o => new byte?((byte)o), // TODO: Add all integer conversions
                ...
                [new TypePair(T<long>(), T<bool>())] = o => ((long)o) != 0,
                [new TypePair(T<long>(), T<bool?>())] = o => new bool?(((long)o) != 0),
                ...
                [new TypePair(T<short>(), T<bool>())] = o => ((short)o) != 0,
                [new TypePair(T<short>(), T<bool?>())] = o => new bool?(((short)o) != 0),
                ...
                [new TypePair(T<ulong>(), T<bool>())] = o => ((ulong)o) != 0,
                [new TypePair(T<ulong>(), T<bool?>())] = o => new bool?(((ulong)o) != 0),
                ...
                [new TypePair(T<ushort>(), T<bool>())] = o => ((ushort)o) != 0,
                [new TypePair(T<ushort>(), T<bool?>())] = o => new bool?(((ushort)o) != 0),
                ...
                [new TypePair(T<SqlByte>(), T<bool>())] = o => ((SqlByte)o).Value != 0,
                [new TypePair(T<SqlByte>(), T<bool?>())] = o => new bool?(((SqlByte)o).Value != 0),
                ...
                [new TypePair(T<SqlDecimal>(), T<bool>())] = o => ((SqlDecimal)o).Value != 0,
                [new TypePair(T<SqlDecimal>(), T<bool?>())] = o => new bool?(((SqlDecimal)o).Value != 0),
                ...
                [new TypePair(T<SqlDouble>(), T<bool>())] = o => ((SqlDouble)o).Value != 0,
                [new TypePair(T<SqlDouble>(), T<bool?>())] = o => new bool?(((SqlDouble)o).Value != 0),
                ...
                [new TypePair(T<SqlInt16>(), T<bool>())] = o => ((SqlInt16)o).Value != 0,
                [new TypePair(T<SqlInt16>(), T<bool?>())] = o => new bool?(((SqlInt16)o).Value != 0),
                [new TypePair(T<SqlInt16>(), T<short>())] = o => ((SqlInt16)o).Value,
                [new TypePair(T<SqlInt16>(), T<short?>())] = o => new short?(((SqlInt16)o).Value),
                [new TypePair(T<SqlInt32>(), T<bool>())] = o => ((SqlInt32)o).Value != 0,
                [new TypePair(T<SqlInt32>(), T<bool?>())] = o => new bool?(((SqlInt32)o).Value != 0),
                [new TypePair(T<SqlInt32>(), T<int>())] = o => ((SqlInt32)o).Value,
                [new TypePair(T<SqlInt32>(), T<int?>())] = o => new int?(((SqlInt32)o).Value),
                [new TypePair(T<SqlInt64>(), T<bool>())] = o => ((SqlInt64)o).Value != 0,
                [new TypePair(T<SqlInt64>(), T<bool?>())] = o => new bool?(((SqlInt64)o).Value != 0),
                [new TypePair(T<SqlInt64>(), T<long>())] = o => ((SqlInt64)o).Value,
                [new TypePair(T<SqlInt64>(), T<long?>())] = o => new long?(((SqlInt64)o).Value),
                [new TypePair(T<SqlMoney>(), T<bool>())] = o => ((SqlMoney)o).Value != 0,
                [new TypePair(T<SqlMoney>(), T<bool?>())] = o => new bool?(((SqlMoney)o).Value != 0),
                [new TypePair(T<SqlMoney>(), T<decimal>())] = o => ((SqlMoney)o).Value,
                [new TypePair(T<SqlMoney>(), T<decimal?>())] = o => new decimal?(((SqlMoney)o).Value),
                [new TypePair(T<SqlSingle>(), T<bool>())] = o => ((SqlSingle)o).Value != 0,
                [new TypePair(T<SqlSingle>(), T<bool?>())] = o => new bool?(((SqlSingle)o).Value != 0),
